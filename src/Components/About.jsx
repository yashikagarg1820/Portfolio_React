...
const About = () => {
   ...
   useEffect(()=>{
     ...
     function func(){
           window.open("https://docs.google.com/document/d/1WcomGxpqWKkE_MZsCGRO4THUBIwEccKo/edit?usp=drive_link&ouid=105120771706223475938&rtpof=true&sd=true")
     }
  ...
  return (  
    <div id="About" className='p-10  flex flex-col items-center justify-center'>
          <h1 data-aos='fade-right' className='text-[52px] font-semibold mb-20 leading-normal  text-fuchsia-500'>About me</h1>
                ...
                <div className='lg:px-46 px-10 lg:py-0 py-25 text-center gap-5 lg-text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-21'>
          ...
          {/* <div className='h-full lg:py-25 flex flex-wrap items-center justify-center text-white'> */}
                  ...
                  <p data-aos='fade-right' className='flex mt-10 allign-left text-white'>
...
<br/>
 Feel free to check out my projects and get in touch!
                  ...
                  <div className='flex mt-0 gap-1 lg:ml-125 ml-20'>
